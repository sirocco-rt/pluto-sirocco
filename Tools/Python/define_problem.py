...
#      self.additional_files += ['cooling_source.o','cooling_ode_solver.o']
  ...
  def AppendPlutoPathAndFlags(self):
    ...
    line_mode = self.default[self.entries.index('LINE_DRIVEN_WIND')]
    if line_mode != 'NO' or cool_mode == 'BLONDIN':
      self.pluto_path.append('LineDriven/')
