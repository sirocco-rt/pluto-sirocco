...
class PlutoFiles(object):
  ...
  def ReplaceObsoletes(self):
    oldwords = ['INCLUDE_ROTATION', 'INCLUDE_BODY_FORCE', 'INCLUDE_COOLING',
                'INCLUDE_BACKGROUND_FIELD', 'TIME_EVOLUTION',
                'RAYMOND', 'NEQ', 'CT_VEC_POT_INIT', 'USE_VECTOR_POTENTIAL',
                'SAVE_VEC_POT']
    newwords = ['ROTATING_FRAME', 'BODY_FORCE', 'COOLING',
                'BACKGROUND_FIELD', 'TIME_STEPPING',
                'SNEq','MINEq', 'USE_VECTOR_POTENTIAL', 'ASSIGN_VECTOR_POTENTIAL',
