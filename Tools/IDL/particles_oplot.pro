...
;                  to be plotted. 
;                  For 2D plots in the XY plane, the default is 
;                  x1p=parts.x1 and x2p=parts.x2 and they do not need to be 
;                  specified. However, for YZ or XZ slices, x1,x2 should be 
;                  provided
;                  
;
; EXAMPLES:
...
; LAST MODIFIED:
;
; 28 Jan 2022, D. Mukherjee (dipanjan.mukherjee@unito.it) 
;              A. Mignone
;
;-
