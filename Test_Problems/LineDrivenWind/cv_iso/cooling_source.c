...
double gSirocco_xi, gSirocco_t_r;
double gComp_heat_pre, gComp_cool_pre;
double gXray_heat_pre, gLine_cool_pre;
double gBrem_cool_pre, gXi_ion_pre;
...
/* --------------------------------------------------------
  ...
  /* ------------------------------------------------------
    ...
    // --- User defined part
    gSirocco_xi  = d->sirocco_xi[k][j][i];
    gSirocco_t_r = d->sirocco_t_r[k][j][i];
//
    gComp_heat_pre = d->comp_h_pre[k][j][i];
    gComp_cool_pre = d->comp_c_pre[k][j][i];
    gXray_heat_pre = d->xray_h_pre[k][j][i];
    gLine_cool_pre = d->line_c_pre[k][j][i];
    gBrem_cool_pre = d->brem_c_pre[k][j][i];
    gXi_ion_pre    = d->xi_ion_pre[k][j][i];
