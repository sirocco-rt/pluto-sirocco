...
void GaussianElimination (double **, double *, double *, int);
...
void ODE_Solve(double *, int, double, double, double, 
               void (*rhs)(double, double *, double *), int);
...
double GaussQuadrature2D(double (*func)(double, double),
                         double, double,
                         double, double, int);
double InitGaussAverage(intList *, 
                        double, double, 
                        double, double, 
                        double, double, double *,
                        int, int, int);
void   GaussianWeights (double *, double *, int);
